...
export class RunsController {
  ...
  @Post()
  @ApiOperation({ summary: 'Create analysis run', description: 'Start a new resume analysis run against a job description' })
  ...
  @Get(':id')
  @ApiOperation({ summary: 'Get analysis run', description: 'Retrieve a specific analysis run with its results' })
